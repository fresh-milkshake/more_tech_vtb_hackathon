...
from app.api.v1 import interviews, candidates, auth, vacancies, interview_links, candidate_access, realtime
...
def configure_api_routes():
    ...
    interview links, candidate access, interviews, candidates, and realtime.
    """
